...
[BASE] = LAYOUT_gergo(
    ...
    KC_LALT,              SYMB,                 LT(NUMB, KC_BSPC), LT(SYMB, KC_DEL),   LT(SYMB, KC_ENT), LT(NUMB, KC_SPC), SYMB, KC_RALT
    ),
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_GRV,  KC_TILD, KC_LBRC, KC_RBRC, KC_TILD, KC_TRNS, KC_TRNS,        KC_PGUP, KC_TRNS, KC_AMPR, KC_EQL,  KC_COMM, KC_LBRC, KC_RBRC, KC_TRNS,
