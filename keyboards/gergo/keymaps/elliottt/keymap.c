 ...
 */
[BASE] = LAYOUT_gergo(
    LT(NUMB, KC_EQUAL),   KC_Q,  KC_W,   KC_E,   KC_R, KC_T,                                              KC_Y,    KC_U, KC_I, KC_O,   KC_P,    KC_BSLS,
    ...
    MT(MOD_LGUI, KC_DEL), MT(MOD_LALT, KC_ENT), LT(NUMB, KC_BSPC), LT(SYMB, KC_DEL),   LT(SYMB, KC_ENT), LT(NUMB, KC_SPC), KC_TAB, KC_BSPC
    ),
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_TILD, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  KC_TRNS,                          KC_TRNS, KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_PERC, KC_QUOT,
    KC_TRNS, KC_GRV,  KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, KC_TRNS, KC_TRNS,        KC_PGUP, KC_TRNS, KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_TRNS,
