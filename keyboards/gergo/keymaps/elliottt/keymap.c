...
[BASE] = LAYOUT_gergo(
    ...
    MT(MOD_LCTL, KC_TAB), LCTL_A, KC_S,   KC_D, KC_F,   KC_G, KC_ESC,                      KC_ESC,  KC_H, KC_J,   KC_K,    KC_L,   RCTL_SC, MT(MOD_RCTL, KC_QUOT),
    KC_LSFT,              LGUI_Z, KC_X,   KC_C, KC_V,   KC_B, KC_LGUI, KC_TRNS,   KC_PGDN, KC_RGUI, KC_N, KC_M,   KC_COMM, KC_DOT, RGUI_SL, KC_RSFT,
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_BSLS, KC_LT,   KC_GT,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        KC_PGUP, KC_TRNS, KC_TRNS, KC_EQL,  KC_LBRC, KC_RBRC, KC_QUES, KC_TRNS,
                                        KC_TRNS, KC_ESC,  KC_TRNS, KC_TRNS,        KC_TRNS, KC_ESC,  KC_TRNS, KC_TRNS
    ),
...
[NUMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN3, KC_TRNS, KC_TRNS, KC_TRNS,     KC_PGUP, KC_TRNS,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_MPLY, KC_MNXT,
                                        KC_TRNS, KC_TRNS, KC_ESC,  KC_TRNS,     KC_TRNS, KC_ESC,   KC_TRNS, KC_TRNS
    ),
/* Function Keys
 *
 * ,-------------------------------------------.                         ,-------------------------------------------.
