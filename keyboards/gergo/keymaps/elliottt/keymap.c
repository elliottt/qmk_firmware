...
[BASE] = LAYOUT_gergo(
    ...
    KC_LSFT,              KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_LGUI, KC_TRNS,     KC_PGDN, KC_RGUI,  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_PIPE, KC_LPRN, KC_RPRN, KC_TILD, KC_GRV,  KC_TRNS,                          KC_TRNS, KC_PLUS, KC_COLN, KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_BSLS, KC_LT,   KC_GT,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        KC_PGUP, KC_TRNS, KC_TRNS, KC_EQL,  KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS,
